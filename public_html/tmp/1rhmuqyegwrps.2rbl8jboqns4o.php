...
<body class="bc-white h-full flex flex-col justify-start content-center items-center gray200 xs:pl-4 xs:pr-4" >
		...
		<div class="flex flex-col w-1/4 xs:w-full sm:w-2/4 md:w-3/6 box-border elevation-4 rounded mt-20"  >
			...
			<form action="/login/password-reset-validate" method="get" >
			...
			<div class="w-full flex items-stretch flex-shrink-0 h-13 lightblue700 text-white rounded-tr rounded-tl">
				...
				<div>
					...
					<div class="w-full flex flex-col pt-3 pb-1 pl-3 pr-3 box-border flex ">
						...
						<input name="mail" value="c4rl0sill3sc4@gmail.com" class="box-boder bg-white rounded-md rounded-md:focus p-2.5 pl-8 border-2 border-blue100 border-blue300:focus border-solid outline-none:focus outline-offset-2:focus text-bluegray800" type="text" placeholder="Correo Eléctronico" autocomplete="off" autocapitalize >
					</div>
				...
				<div class="w-full pl-3 pr-3 box-border pb-3 pt-3">
					<button type="submit" class="blue700 blue800:hover w-full box-border text-white pt-2.5 pb-2.5 aoutline-none border-none rounded-lg cursor-pointer" >Recuperar</button>
				</div>
