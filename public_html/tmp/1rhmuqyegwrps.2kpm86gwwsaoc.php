			...
			<div class="w-full flex items-stretch flex-shrink-0 h-13 lightblue700 text-white rounded-tr rounded-tl">
				...
				<div>
					...
					<div class="w-full flex flex-col pt-3 pb-1 pl-3 pr-3 box-border">
						<input class="box-boder bg-white rounded-md rounded-md:focus p-2.5 border-2 border-blue100 border-blue300:focus border-solid outline-none:focus outline-offset-2:focus text-bluegray800" type="text" placeholder="" autocomplete="off" autocapitalize>
					</div>
				...
				<div class="w-full pl-3 pr-3 box-border pb-4 pt-4">
					...
					<button onclick="window.location.href='/install/setup-account'" class="blue700 blue800:hover w-full box-border text-white pt-2.5 pb-2.5 aoutline-none border-none rounded-lg cursor-pointer" >Conectar</button>
				</div>
		</div>
